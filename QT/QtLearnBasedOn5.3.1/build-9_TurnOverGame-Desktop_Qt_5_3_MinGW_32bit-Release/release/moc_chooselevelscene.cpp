...
#include "../../9_TurnOverGame/chooselevelscene.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ChooseLevelScene_t, stringdata) + ofs \
...
const QMetaObject ChooseLevelScene::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ChooseLevelScene.data,
      qt_meta_data_ChooseLevelScene,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ChooseLevelScene.stringdata))
