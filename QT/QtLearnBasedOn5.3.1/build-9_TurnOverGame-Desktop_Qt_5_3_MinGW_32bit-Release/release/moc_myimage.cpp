...
#include "../../9_TurnOverGame/myimage.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyImage_t, stringdata) + ofs \
...
const QMetaObject MyImage::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_MyImage.data,
      qt_meta_data_MyImage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyImage.stringdata))
        return static_cast<void*>(const_cast< MyImage*>(this));
