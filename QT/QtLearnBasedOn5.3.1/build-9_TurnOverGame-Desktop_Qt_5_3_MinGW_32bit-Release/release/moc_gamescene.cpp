...
#include "../../9_TurnOverGame/gamescene.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GameScene_t, stringdata) + ofs \
...
void GameScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameScene::chooseSceneBack)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject GameScene::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_GameScene.data,
      qt_meta_data_GameScene,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GameScene.stringdata))
...
// SIGNAL 0
void GameScene::chooseSceneBack()
{
