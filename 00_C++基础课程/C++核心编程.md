...
* 链接：[黑马程序视频课程](https://www.bilibili.com/video/BV1et411b73Z?p=84&vd_source=54d6f5e269c668b7d2e2c71481a13789)
...
![1545017602518](https://cdn.jsdelivr.net/gh/ChaseYangGithub/MyBlogResource@main/MD/202301090105300.png)
...
int main() {
	...
	int a = 10;
	func(a); //调用无const
	func(10);//调用有const此时走const是因为 int &a=10不合法，而const int &a合法（详细见函数const部分）
...
![1545533548532](https://cdn.jsdelivr.net/gh/ChaseYangGithub/MyBlogResource@main/MD/202301090105302.png)
...
![1545533829184](https://cdn.jsdelivr.net/gh/ChaseYangGithub/MyBlogResource@main/MD/202301090105303.png)
...
void test02() {
	...
	//注意2：不能利用 拷贝构造函数 初始化匿名对象 编译器认为是对象声明 Human (h5)==Human h5
	//Person (p4);
}
...
public:
	...
	//成员函数实现 + 号运算符重载
	Person operator+(const Person& p) {//拷贝参数
		Person temp;
...
![1544861202252](https://cdn.jsdelivr.net/gh/ChaseYangGithub/MyBlogResource@main/MD/202301090105304.png)
...
![image-20230128125410830](https://cdn.jsdelivr.net/gh/ChaseYangGithub/MyBlogResource@main/MD/202301281254268.png)
...
![1545881904150](https://cdn.jsdelivr.net/gh/ChaseYangGithub/MyBlogResource@main/MD/202301090105306.png)
...
![1545882158050](https://cdn.jsdelivr.net/gh/ChaseYangGithub/MyBlogResource@main/MD/202301090105307.png)
...
![IMG_256](https://cdn.jsdelivr.net/gh/ChaseYangGithub/MyBlogResource@main/MD/202301090105308.jpg)
...
![1545985945198](https://cdn.jsdelivr.net/gh/ChaseYangGithub/MyBlogResource@main/MD/202301090105309.png)
...
![image-20230201231653934](https://cdn.jsdelivr.net/gh/ChaseYangGithub/MyBlogResource@main/MD/202302012317989.png)
